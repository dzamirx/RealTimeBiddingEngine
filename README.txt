...
3. a user request for campaign will initially check the local service cache for campaign queue
...
8. priority queue will sort the campaigns immidiatly upon insertion based on the priority parameters
